...
public class PaintThings {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sphere Paint Amount = " + finalSphereAmount);

		Rectangle rec = new Rectangle(20, 35);
		double recArea = rec.area();
		double finalRecAmount = p1.amount(recArea);
		System.out.println(rec.toString());
		System.out.println("Rectangle Paint Amount = " + finalRecAmount);
		...
		System.out.println("Cylinder Paint Amount = " + finalCylArea);
